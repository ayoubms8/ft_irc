...
1. [About the project](https://github.com/ayoubms8/Ft_irc#school_satchel-about-this-project)
* [Definition](https://github.com/ayoubms8/Ft_irc#_-crystal_ball-definition)
* [Subject requirements](https://github.com/ayoubms8/Ft_irc#_-floppy_disk-subject-requirements)
* [Commands that we implemented](https://github.com/ayoubms8/Ft_irc#high_brightness-commands-that-we-implemented-)
2. [Some tips, graphs and other ressources](https://github.com/ayoubms8/Ft_irc#gift-some-tips-graphs-and-other-ressources)
* [Helpful links](https://github.com/ayoubms8/Ft_irc#_-books-helpful-links)
* [Tips](https://github.com/ayoubms8/Ft_irc#_-books-helpful-links)
___
...
___
### :high_brightness: Commands that I implemented :
...
- **A suggestion of project roadmap :** 
  ...
  4- The channel operations commands (`JOIN`, `PART`, `INVITE`, `KICK`, `PRIVMSG`, `NOTICE`...).
